...
def resource_path(relative_path):
    """ Get absolute path to resource, works for dev and foe PyInstaller """
...
class Main(QMainWindow, FORM_CLASS):
    ...
    def GET_DATA(self):
        # Connect to SQLite3 database and fill the table on the Inventory Details page
        ...
        # Display references number and type number in Inventory Statistics page
        cursor2 = db.cursor()
        cursor3 = db.cursor()
        ...
        # Display Min, Max, Number of Holes in Inventory Statistics page
